...
export default function TestPage() {
  ...
  async function handleUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const signRes = await fetch("/api/videos/upload-sign", { method: "POST" });
      ...
      // Note: You might need to hardcode API Key here for testing if env var isn't exposed to client
      // Or better: pass apiKey from the sign endpoint response
